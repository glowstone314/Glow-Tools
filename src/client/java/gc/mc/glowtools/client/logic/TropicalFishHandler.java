...
public class TropicalFishHandler {
    ...
    private static void triggerAlert(TropicalFishEntity fish) {
        ...
        Text msg = Text.translatable("glowtools.chat.tropical_fish.found", Reference.chatPrefix, variantName, formatPos(fish.getPos()));
    ...
    public static boolean isTargetFish(Entity entity) {
        ...
        if (!(entity instanceof TropicalFishEntity fish)) return false;
