...
public class GuiSchematicGenerator extends GuiBase {
    ...
    public void initGui() {
        ...
        if (!IS_LITEMATICA_LOADED) {
            ...
            this.addButton(downloadButton, (button, mouseButton) ->
                    ConfirmLinkScreen.open("https://modrinth.com/mod/litematica", this, true));

            ButtonGeneric backButton = new ButtonGeneric(this.width - 120, this.height - 30,
        ...
        ButtonGeneric backButton = new ButtonGeneric(this.width - 120, y, 100, 20, label4);
        this.addButton(backButton, (button, mouseButton) -> GuiBase.openGui(new GuiConfigs()));
    }
    ...
    private void createSchematic() {
        ...
        try {
            wrapper = mc.getNetworkHandler().getRegistryManager().getWrapperOrThrow(RegistryKeys.BLOCK);
        } catch (Exception e) {
